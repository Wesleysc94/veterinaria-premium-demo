...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden px-6 pb-14 pt-32 sm:px-8 lg:px-12">
      ...
      <div className="mx-auto max-w-6xl rounded-[2rem] border theme-adaptive-surface px-7 py-10 shadow-[0_30px_120px_-55px_rgba(39,51,46,0.28)] backdrop-blur md:px-12 md:py-14">
